...
if matches[1]== "off smaker" or  matches[1]== "off sticker" then
...
if matches[1]== "on smaker" or matches[1]== "off sticker" then
    if is_sudo(msg) then
lock = 0
...
--—------------------------------
if matches[1] == "/sticker"or matches[1] == "+sticker"or matches[1] == "!sticker" then
    if lock == 0 then
